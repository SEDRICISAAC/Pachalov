...
// const API = "http://192.168.100.89:5000/server/time/allTips";
const API = "http://localhost:3000/server/time/allTips";
...
class Tips extends Component {
    ...
    logicDelete = (item) => {
        ...
        .then(response => {
            window.location.assign("http://localhost:3000/tips");
        })
        .catch(error => {
            console.log(error);
        });
               ...
               <Header />
                ...
                <div className="ml-64">
                    ...
                    <main className="my-8">
                        ...
                        <p className="text-center my-5 text-2xl">Tips</p>
                        <div className="flex flex-wrap items-center justify-center">
                        { this.state.tips.map(element => 
                            <div className="max-w-md w-full lg:flex" key={ element.id }>
                                {/* <img className="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" src={ element.imagen } alt="imagen" /> */}
                                <div className="border-r border-b border-l border-grey-light lg:border-l-0 lg:border-t lg:border-grey-light bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                                    <div className="mb-8">
                                        ...
                                        <p className="text-grey-darker text-base">{ element.contenido }</p>
                                    </div>
                                    {/* <div className="flex items-center">
